...
ResultSet rs;
	...
	public void insertBoard(BoardBean bb) {
		...
		try {
			...
			sql="insert into fboard(num, name, pass, subject, content, readcount, date, file)"
					+ " values(?, ?, ?, ?, ?, ?, now(),?)";
			 ps = con.prepareStatement(sql);
	...
	public int getBoardCount() {
		...
		try {
			...
			String sql = "select count(num) from fboard"; //sql 게시판 글수 세기
			ps = con.prepareStatement(sql);
	...
	public int getBoardCount(String search) {
		...
		try {
			con = getConnection();//디비연결
			String sql = "select count(*) from fboard where subject like ?"; //sql 게시판 글수 세기
			ps = con.prepareStatement(sql);
