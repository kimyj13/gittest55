...
%>
<tr onclick="location.href='fcontent.jsp?num=<%=bb.getNum()%>&pageNum=<%=pageNum%>'"><td><%=num-- %></td><td class="left">
<%=bb.getSubject() %></td>
...
if(count != 0){
	...
	if(endPage < pageCount){
		%><a href="fnotice.jsp?pageNum=<%=endPage+1%>"><!-- startPage+pageBlock -->Next</a><%
	}
}
